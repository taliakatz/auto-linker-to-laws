...
$(document).ready(function(){
   ...
   function main () {
    ...
    uriMap.forEach( law => {
      ...
      let mainName = law.OfficialName.split(" ", 2);
      // let i = 1;
      // let ch = mainName[i];
      let s = mainName[0].concat(' ').concat(mainName[1]);
      
      // create a new object for law {id, name, url}
      lawsList.push({id: law.Id, name: s, url: law.KnessetUrl});
    });
  ...
  function searchLaws(lawsList) {
    let law = lawsList[0];
    let url = law.url;
    let ref = '<a href=' + '"'+ url +'"' + '>'+ law.name + '</a>';    //prepare the law's url
    var replaced = $("body").html().replace(/חוק שכר/g, ref);
    $("body").html(replaced);
  }
...
// create a new array of main names

// uriMap.forEach( law => {
//     let mainName = law.OfficialName.split(" ");
//     let i = 1;
//     let ch = mainName[i].charAt(0);
//     let s = mainName[0];
//     while ( mainName.length > 1 && i < mainName.length && mainName[i].charAt(0) != '(' && mainName[i].charAt(0) != ')' 
//     && (i < mainName.length-1 && mainName[i].charAt(mainName[i+1].length) != ',')) 
//     {
//       s = s.concat(' ').concat(mainName[i]);
...
// $(document).ready(function(){
//    debugger;
//    var res = $(":contains(חוק)");

//     var ind_of_law = $("body").html().indexOf('חוק');
//     if(ind_of_law != -1 )
//       console.log(ind_of_law);
...
//     let url = law.url;
//     let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//     var replaced = $("#firstHeading").html().replace(/law.name/g, ref);
//     $("body").html(replaced);
//     })
//   });


// this was last in use


// $(document).ready(function(){
   
  //   var replaced = $("body").html().replace(/חוק/g, '<a href="https://he.wikipedia.org/wiki/%D7%97%D7%95%D7%A7">חוק</a>');
  //   $("body").html(replaced);
...
// let tags = ["H1", "H2", "H3", "H4", "P", "B", "DIV", "LABEL", "A", "SMALL", "TD", "TH", "TITLE", "TR", "STRONG"];

// let h1 = document.getElementsByTagName("H1");   //h1 is a html collection
// lawsList.forEach(law => {  //for every law in laws list, pass every node in the page and compare 
//         let url = law.url;
//         let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//         for (let i = 0; i < h1.length; i++) {
//             origText = h1[i].textContent;
//             let newHtml = origText.replace(/\blaw.name\b/g, ref);
//             if( newHtml !== origText) {
//                 let newSpan = document.createElement('span');
//                 newSpan.innerHTML = newHtml;
//                 h1[i].parentNode.replaceChild(newSpan, h1[i]);
//             }  
//         }  
// })

// let h2 = document.getElementsByTagName("H2");   //h2 is a html collection
// lawsList.forEach(law => {  //for every law in laws list, pass every node in the page and compare 
//         let url = law.url;
//         let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//         for (let i = 0; i < h2.length; i++) {
//             origText = h2[i].textContent;
//             let newHtml = origText.replace(/\blaw.name\b/g, ref);
//             if( newHtml !== origText) {
//                 let newSpan = document.createElement('span');
//                 newSpan.innerHTML = newHtml;
//                 h2[i].parentNode.replaceChild(newSpan, h2[i]);
//             }  
//         }  
// })

// let h3 = document.getElementsByTagName("h3");   //h3 is a html collection
// lawsList.forEach(law => {  //for every law in laws list, pass every node in the page and compare 
//         let url = law.url;
//         let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//         for (let i = 0; i < h3.length; i++) {
//             origText = h3[i].textContent;
//             let newHtml = origText.replace(/\blaw.name\b/g, ref);
//             if( newHtml !== origText) {
//                 let newSpan = document.createElement('span');
//                 newSpan.innerHTML = newHtml;
//                 h3[i].parentNode.replaceChild(newSpan, h3[i]);
//             }  
//         }  
// })

// let h4 = document.getElementsByTagName("h4");   //h4 is a html collection
// lawsList.forEach(law => {  //for every law in laws list, pass every node in the page and compare 
//         let url = law.url;
//         let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//         for (let i = 0; i < h4.length; i++) {
//             origText = h4[i].textContent;
//             let newHtml = origText.replace(/\blaw.name\b/g, ref);
//             if( newHtml !== origText) {
//                 let newSpan = document.createElement('span');
//                 newSpan.innerHTML = newHtml;
//                 h4[i].parentNode.replaceChild(newSpan, h4[i]);
//             }  
//         }  
// })
...
// let b = document.getElementsByTagName("B");   //b is a html collection
// lawsList.forEach(law => {  //for every law in laws list, pass every node in the page and compare 
//         let url = law.url;
//         let ref = '<a href=' + url + '>'+ law.name + '</a>';    //prepare the law's url
//         for (let i = 0; i < b.length; i++) {
//             origText = b[i].textContent;
//             let newHtml = origText.replace(/\blaw.name\b/g, ref);
//             if( newHtml !== origText) {
//                 let newSpan = document.createElement('span');
//                 newSpan.innerHTML = newHtml;
//                 b[i].parentNode.replaceChild(newSpan, b[i]);
//             }  
//         }   
// })
...
// lawsList.forEach(law => {
//     h1Array.forEach(h => {
//         let origText = h.textContent;
//         let newHtml = origText.replace(/\blaw.name\b/g,'<a href="+law.url+">"+law.name+"</a>');
//         if( newHtml !== origText) {
//             let newSpan = document.createElement('span');
//             newSpan.innerHTML = newHtml;
//             h.parentNode.replaceChild(newSpan, h1);
//         }  
//     }) 
// })

// let paragraph = document.getElementsByTagName("P");
// let paragraphArray = Array.from(h1);
// lawsList.forEach(law => {
//     paragraphArray.forEach(p => {
//         let origText = p.textContent;
//         let newHtml = origText.replace(/\bLaw\b/g,'<a href="+law.url+">"+law.name+"</a>');
//         if( newHtml !== origText) {
//             let newSpan = document.createElement('span');
//             newSpan.innerHTML = newHtml;
//             p.parentNode.replaceChild(newSpan, paragraph);
//         }  
//     }) 
// })

// let textNode = document.getElementsByTagName("H1")[0];
// let origText = textNode.textContent;
// let newHtml=origText.replace(/\bLaw\b/g,'<a href="http://www.cnn.com">asdf</a>');
...
//     let element = paragraph[i].value;
//     uriMap.forEach(law => {
//         if(element.indexOf(law.OfficialName) =! -1){
//             let parse = law.OfficialName.parse(' ')
//             let lastword = parse[parse.size];
//             let ind = element.indexOf(law.OfficialName);
...
// }
// let span = getElementsByTagName("SPAN");
// let head1 = getElementsByTagName("H1");
// let head2 = getElementsByTagName("H2");
// let head3 = getElementsByTagName("H3");
// let head4 = getElementsByTagName("H4");